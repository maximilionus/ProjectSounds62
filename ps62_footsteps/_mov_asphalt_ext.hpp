...
class walkErc_asphalt_ext_asphalt_ext_walkErc_Zmb_SoundShader: walkErc_asphalt_ext_asphalt_ext_walkErc_Char_SoundShader
{
	volume=0.2;
	frequency=1;
};
class runErc_asphalt_ext_asphalt_ext_runErc_Zmb_SoundShader: runErc_asphalt_ext_asphalt_ext_runErc_Char_SoundShader
{
	volume=0.30000001;
	frequency=1;
};
class sprintErc_asphalt_ext_asphalt_ext_sprintErc_Zmb_SoundShader: sprintErc_asphalt_ext_asphalt_ext_sprintErc_Char_SoundShader
{
	volume=0.43000001;
	frequency=1;
};